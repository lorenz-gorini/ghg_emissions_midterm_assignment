...
Social and Health
Social | Cause of death, by communicable diseases and maternal, prenatal and nutrition conditions (% of total)
Social | Children in employment, total (% of children ages 7-14)

Social | Ease of doing business rank (1=most business-friendly regulations)
...
Count NaN for few ESG indicators in order to identify the year associated with the lowest number of NaNs
```{R}
esg_raw_selected_indicators <- esg_raw[esg_raw$Indicator.Name %in% indicators_for_nan_plot, ]
